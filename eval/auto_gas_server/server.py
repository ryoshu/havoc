...
class AutoGasRuntime(EnforcedGasMixin):
    ...
    def __init__(self, db_path: str = ":memory:", mode: str = "gas-advisory", *, advertise_capabilities: bool | None = None):
        self.ctx = AutoContext(db_path=db_path)
        self.engine = AutoEngine()
        self.mode = mode
        self.advertise_capabilities = mode != "gas-generic" if advertise_capabilities is None else advertise_capabilities
